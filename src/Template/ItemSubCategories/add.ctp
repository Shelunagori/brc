...
<div class="row">
			...
			<div class="portlet-body">
				<div class="">
					<?= $this->Form->create($itemSubCategory,['id'=>'CountryForm']) ?>
						...
						<div class="form-group">
							<label class="control-label col-md-4"> Select Category <span class="required" aria-required="true">
							* </span>
							</label>
							<div class="col-md-8">
								<div class="input-icon right">
									<i class="fa"></i>
									<?php  
									echo $this->Form->input('item_category_id',['options' =>$itemCategories,'label' => false,'class'=>'form-control select2 selectState','empty'=> 'Select...']);?>
								</div>
							</div>
						</div>
	...
	<div class="col-md-6">
		...
		<div class="portlet blue box">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-book"></i>View Sub Category List
				</div>
				<div class="tools"> 
 				</div>
			</div>
				...
				<table class="table table-bordered" cellpadding="0" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td class="actions">
								<?php echo $this->Html->link('<i class="fa fa-edit"></i>','/ItemSubCategories/add/'.$country->id,array('escape'=>false,'class'=>'btn btn-warning btn-xs'));?>
